...
export default function PrivacyPolicyPage() {
  return (
    <main className="max-w-3xl mx-auto p-6">
      ...
      <p className="mb-4">Last updated: February 2025</p>

      <h2 className="text-xl font-semibold mt-4">1. Information We Collect</h2>
      <p className="mb-2">
        We collect personal information such as your email and name when you
      ...
      <p className="mb-2">
        We use your data to provide authentication services and improve our
        platform.
      </p>
      ...
      <p>
        ...
        <a href="mailto:tufailahmed.dev@gmail.com" className="text-blue-500">
          tufailahmed.dev@gmail.com
        </a>
        .
      </p>
    </main>
