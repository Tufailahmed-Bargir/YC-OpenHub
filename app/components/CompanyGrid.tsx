    ...
    <div className="bg-white" id="companies">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Open Source YC Companies</h2>
              ...
              <div key={company.name} className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-500">{company.description}</p>
                  </div>
                </div>
              </div>
            ))}
