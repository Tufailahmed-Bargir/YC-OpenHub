    ...
    <div className="bg-white" id="companies">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="lg:text-center">
          <h2 className=" font-bold  text-6xl text-indigo-600  tracking-wide uppercase">
            Open Source YC Companies
          </h2>
          <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            Innovate with the Best
          </p>
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            Explore and contribute to groundbreaking open-source projects from Y
                  ...
                  <div className="-mt-6">
                    <div>
                      <span className="inline-flex items-center justify-center p-3  rounded-md shadow-lg">
                        <Image
                          src={
                            company.small_logo_thumb_url || "/placeholder.svg"
                          }
                          alt={company.name}
                          width={32}
                          height={32}
